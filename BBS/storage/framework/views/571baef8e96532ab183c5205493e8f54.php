...
<?php $component->withAttributes([]); ?>
	 <?php $__env->slot('title', null, []); ?> 新しい記事の作成 <?php $__env->endSlot(); ?>
    ...
    <div class="py-12">
        <div class="max-w-2xl px-6 lg:px-8">
            <form class="grid grid-cols-1 gap-6" method='POST' action="<?php echo e(route('store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <label class="block">
...
<?php endif; ?><?php /**PATH C:\Users\OWNER\Desktop\laravel_app\BBS\resources\views/create.blade.php ENDPATH**/ ?>